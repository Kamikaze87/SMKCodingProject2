...
import com.kamikaze.smkcodingproject2.adapter.LokalAdapter2
   ...
   val httpClient = httpClient()
        ...
        val call = apiRequest.getLokal()
                call.enqueue(object : Callback<List<LokalData1Item>>{
                    ...
                    override fun onFailure(call: Call<List<LokalData1Item>>, t: Throwable) {
    ...
    override fun onResponse(call: Call<List<LokalData1Item>>, response:
    Response<List<LokalData1Item>>){
        dismissLoad(swipeRefreshLokal)
